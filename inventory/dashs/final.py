...
def filter_container():
    filter_container = html.Div([
        ...
        dbc.Row([
                ...
                dbc.Col([
                    dash_utils.get_filter_dropdown(
                        dropdown_product_list_id, div_product_list_id, checkbox_product_list_id, _all_products, 'Products')
                ], sm=12, md=6, lg=4),
                dbc.Col([
                    dash_utils.get_filter_dropdown(
                ...
                dbc.Col([
                    dash_utils.get_filter_dropdown(
                        dropdown_location_list_id, div_location_list_id, checkbox_location_list_id, _all_locations, 'Locations')
                ], sm=12, md=6, lg=4),
                dbc.Col([
